...
\begin{tikzpicture}[node distance = 4cm, auto]
    ...
    \node [block, right of=References] (New-Ticket) {Create new Ticket};
    ...
    \path [line] (References) -- node {no} (New-Ticket) ;
    \path [line] (identify) -| node [near start] {no ticket id found} (New-Ticket) ;
